...
const MODULES = [
  { id: 1, title: "Modul 1: Universella lagar & kvantfysik", desc: "Förstå ditt medvetna/undermedvetna, energi & frekvenser. Daglig tacksamhet." },
  { id: 2, title: "Modul 2: Soul Vision – Att sätta mål", desc: "Skapa livsmanus, vision & Basecamp. Sätt mål från hjärtat." },
  { id: 3, title: "Modul 3: Omprogrammera dina paradigm", desc: "Identifiera inre program, vänd kritikern, skapa affirmationer." },
  { id: 4, title: "Modul 4: Att börja göra", desc: "Inspirerade + aligned actions. Vanor, momentum & frekvens." },
  { id: 5, title: "Modul 5: Skräckväggen & Självsabotage", desc: "Navigera rädsla, igenom motståndet till genombrott." },
];
    ...
    <div className="grid lg:grid-cols-3 gap-5">
      <Card className="lg:col-span-2">
        ...
        <div className="space-y-3">
          {[
            { name: "Elin", text: "Vecka 2 och jag vågade äntligen posta min story – 3 leads kom in!" },
            { name: "Samir", text: "Satte två vanor i modul 4. Känner redan mer fokus och lugn." },
          ].map((p, i) => (
